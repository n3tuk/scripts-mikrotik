...
{{- $original := (ds "host").bridge.original }}
...
{{  template "section" "Bootstrap Bridge Interface" }}

/interface bridge

{{  template "component" "Prepare the Bridge"}}
...
{{  template "component" "Pre-Configure the Bridge" }}
