...
{{- /* vim:set ft=routeros: */}}
# Process all IP packets to filter out untrusted BOGONs (bogus networks, or
# selected network ranges which should not be the source or destination of any
# IP packet routed over the internet or local networks). Permitted internal
# networks address ranges are explicitly not included in this list, rather than
# overridden, to ensure we catch BOGONs in traffic to/from internal network
# addresses.
